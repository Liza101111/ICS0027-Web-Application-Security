...
| 4 | HTML / JavaScript injection (XSS) | Any user-supplied text rendered back (e.g. filenames, usernames) | Jinja2 auto-escaping is kept enabled; untrusted content is never marked as safe in Jinja2; Content-Security-Policy can also be used |
